let restaurantSearchButton = document.getElementById("restaurant-search");
    ...
    console.log('restaurantSearchButton', restaurantSearchButton)
})

let restaurantSearchResults = []

let restaurantSearchResDiv = document.getElementById("search-results");
restaurantSearchResDiv.addEventListener("click", function(){
